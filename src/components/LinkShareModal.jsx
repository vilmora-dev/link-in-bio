...
const LinkShareModal = ({ isOpen, onClose, linkUrl, linkLabel, linkImage }) => {
  ...
  const shareOptions = [
    // Messenger
    {
        ...
        href: `https://m.me/?text=${encodeURIComponent(linkLabel)}%20from%20Nimbus's%20picks!%20😻%20${encodeURIComponent(linkUrl)}`,
    ...
    // Whatsapp
    {
        ...
        href: `https://wa.me/?text=${encodeURIComponent(linkLabel)}%20from%20Nimbus's%20picks!%20😻%20${encodeURIComponent(linkUrl)}`,
    ...
    // Share Natively (device options)
    {
        ...
        onClick: () => navigator.share({ title: linkLabel, url: linkUrl, text: `${encodeURIComponent(linkLabel)}%20from%20Nimbus's%20picks!%20😻%20${encodeURIComponent(linkUrl)}` }),
